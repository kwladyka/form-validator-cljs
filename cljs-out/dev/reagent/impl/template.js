...
var G__13280 = o;
(G__13280[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__13282__i < G__13282__a.length) {G__13282__a[G__13282__i] = arguments[G__13282__i + 0]; ++G__13282__i;}
  args = new cljs.core.IndexedSeq(G__13282__a,0,null);
} 
...
var G__13284 = o;
(G__13284[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__13289 = props;
var G__13289__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13289,cljs.core.cst$kw$id,id):G__13289);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13289__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__13290){
...
var props = map__13291__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13291__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__13291,map__13291__$1,props,class$){
return (function (c){
...
});})(map__13291,map__13291__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__13293){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13294__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__13294,map__13294__$1,on_write){
return (function (){
...
});})(node_value,map__13294,map__13294__$1,on_write))
);
} else {
...
var G__13297 = jsprops;
(G__13297["defaultValue"] = value);

(G__13297["onChange"] = ((function (G__13297,v,value,on_change){
return (function (p1__13296_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13296_SHARP_);
});})(G__13297,v,value,on_change))
);
...
var vec__13300 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13300,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13300,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13300,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___13304 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___13304 == null)){
} else {
var key_13305 = temp__5739__auto___13304;
(jsprops["key"] = key_13305);
}
...
var temp__5739__auto___13306 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___13306 == null)){
} else {
var key_13307 = temp__5739__auto___13306;
reagent.impl.template.oset(jsprops,"key",key_13307);
}
...
var G__13308 = reagent.impl.template.__GT_NativeWrapper();
(G__13308["name"] = c);
...
var G__13309 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13309) : reagent.impl.template.as_element.call(null,G__13309));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13313){
var G__13314 = cljs.core.first(seq13313);
var seq13313__$1 = cljs.core.next(seq13313);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13314,seq13313__$1);
});
...
break;
default:
var G__13320 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__13320;
continue;
...
var n__4607__auto___13322 = a.length;
var i_13323 = (0);
while(true){
if((i_13323 < n__4607__auto___13322)){
(a[i_13323] = reagent.impl.template.as_element((a[i_13323])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___13325 = a.length;
var i_13326 = (0);
while(true){
if((i_13326 < n__4607__auto___13325)){
var val_13327 = (a[i_13326]);
if(((cljs.core.vector_QMARK_(val_13327)) && ((reagent.impl.template.key_from_vec(val_13327) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_13326] = reagent.impl.template.as_element(val_13327));
...
var ctx = ({});
var vec__13329 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13329,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13329,(1),null);
...
var G__13332 = (cljs.core.count(argv) - first_child);
switch (G__13332) {
case (0):
...
case (1):
var G__13333 = comp;
var G__13334 = jsprops;
var G__13335 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__13333,G__13334,G__13335) : reagent.impl.template.global$module$react.createElement.call(null,G__13333,G__13334,G__13335));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__13332){
