...
var G__16956 = z;
if(((24) > (function (){var G__16957 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__16957) : clojure.test.check.random.longs.bit_count.call(null,G__16957));
})())){
return clojure.test.check.random.longs.bit_xor(G__16956,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__16956;
}
});
...
var G__16960 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__16961 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__16960;
ret = G__16961;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16963__$1,cljs.core.cst$kw$state);
var vec__16965 = clojure.test.check.random.split(state);
